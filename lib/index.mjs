...
import { Metadata, status, InterceptingCall } from "@grpc/grpc-js";
...
var stringify$1 = function stringify(
  ...
  var adjustedPrefix =
    commaRoundTrip && isArray$1(obj) && obj.length === 1
      ? prefix + "[]"
      : prefix;
...
var normalizeStringifyOptions = function normalizeStringifyOptions(opts) {
  ...
  return {
    ...
    encoder:
      typeof opts.encoder === "function" ? opts.encoder : defaults$1.encoder,
    encodeValuesOnly:
...
pathTemplateToParameterNames.pathTempalteToParameterNames =
...
const names = (template) => {
  const ns = (0, _pathTemplateToParameterNames$2.pathTempalteToParameterNames)(
    template
  );
...
const toParameterPattern = (template, patterns) => {
  const userParameterPatterns =
    typeof patterns === "undefined"
      ...
      : Object.keys(patterns).map((name) => {
          ...
          const pattern =
            typeof patternOrUndefined === "undefined"
              ? null
              : patternOrUndefined;
          return {
            name,
  ...
  const parameterNames = (0,
  _pathTemplateToParameterNames$1.pathTempalteToParameterNames)(template);
  const parameters = parameterNames.map((name) => {
    const userPattern = userParameterPatterns.find(({ name: n }) => n === name);
    const pattern =
      typeof userPattern === "undefined" ? null : userPattern.pattern;
    return {
      name,
      pattern,
    };
...
const params = (template, patterns) => {
  ...
  const parameterPattern = (0, _toParameterPattern$1.toParameterPattern)(
    template,
    patterns
  );
  return (pathname) => {
...
const path = (template, patterns) => {
  const parameterNames = (0,
  _pathTemplateToParameterNames.pathTempalteToParameterNames)(template);
  return (params) => {
    if (parameterNames.some((name) => typeof params[name] !== "string")) {
      return null;
    }

    const parameterPattern = (0, _toParameterPattern.toParameterPattern)(
      template,
      patterns
    );
...
(function (StatusCodes) {
   ...
   */
  StatusCodes[(StatusCodes["HTTP_VERSION_NOT_SUPPORTED"] = 505)] =
   ...
   */
  StatusCodes[(StatusCodes["INSUFFICIENT_SPACE_ON_RESOURCE"] = 419)] =
   ...
   */
  StatusCodes[(StatusCodes["INSUFFICIENT_STORAGE"] = 507)] =
   ...
   */
  StatusCodes[(StatusCodes["NETWORK_AUTHENTICATION_REQUIRED"] = 511)] =
   ...
   */
  StatusCodes[(StatusCodes["NON_AUTHORITATIVE_INFORMATION"] = 203)] =
   ...
   */
  StatusCodes[(StatusCodes["PRECONDITION_FAILED"] = 412)] =
    "PRECONDITION_FAILED";
  /**
   ...
   */
  StatusCodes[(StatusCodes["PRECONDITION_REQUIRED"] = 428)] =
   ...
   */
  StatusCodes[(StatusCodes["PROXY_AUTHENTICATION_REQUIRED"] = 407)] =
   ...
   */
  StatusCodes[(StatusCodes["REQUEST_HEADER_FIELDS_TOO_LARGE"] = 431)] =
   ...
   */
  StatusCodes[(StatusCodes["REQUEST_URI_TOO_LONG"] = 414)] =
   ...
   */
  StatusCodes[(StatusCodes["REQUESTED_RANGE_NOT_SATISFIABLE"] = 416)] =
   ...
   */
  StatusCodes[(StatusCodes["SERVICE_UNAVAILABLE"] = 503)] =
    "SERVICE_UNAVAILABLE";
  /**
   ...
   */
  StatusCodes[(StatusCodes["SWITCHING_PROTOCOLS"] = 101)] =
    "SWITCHING_PROTOCOLS";
  /**
   ...
   */
  StatusCodes[(StatusCodes["UNAVAILABLE_FOR_LEGAL_REASONS"] = 451)] =
   ...
   */
  StatusCodes[(StatusCodes["UNPROCESSABLE_ENTITY"] = 422)] =
   ...
   */
  StatusCodes[(StatusCodes["UNSUPPORTED_MEDIA_TYPE"] = 415)] =
   ...
   */
  StatusCodes[(StatusCodes["MISDIRECTED_REQUEST"] = 421)] =
    "MISDIRECTED_REQUEST";
    ...
    const axiosConfig = {
      ...
      params:
        requestConfig.method === "get"
          ? lib.stringify(requestConfig.query)
          : undefined,
    };
    try {
...
export { interceptor, openapiInterceptor, openapiInterceptorSync };
