...
type GreeterClient interface {
	...
	// 客户端在 request 中给出 metadata 服务端会在响应中设置 metadata，客户端可以进行比较
	Trailer(ctx context.Context, in *MetadataRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/example.greeter.v2.services.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) EqMetadata(ctx context.Context, in *MetadataRequest, opts ...grpc.CallOption) (*EqMetadataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/example.greeter.v2.services.Greeter/EqMetadata", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) Metadata(ctx context.Context, in *MetadataRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/example.greeter.v2.services.Greeter/Metadata", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) Trailer(ctx context.Context, in *MetadataRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/example.greeter.v2.services.Greeter/Trailer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) Status(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/example.greeter.v2.services.Greeter/Status", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	...
	// 客户端在 request 中给出 metadata 服务端会在响应中设置 metadata，客户端可以进行比较
	Trailer(context.Context, *MetadataRequest) (*emptypb.Empty, error)
	// 客户端在 request 中给出一个状态码和错误信息，服务端会已对应的状态码进行响应
...
func (UnimplementedGreeterServer) Trailer(context.Context, *MetadataRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Trailer not implemented")
}
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.greeter.v2.services.Greeter/SayHello",
	}
...
func _Greeter_EqMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.greeter.v2.services.Greeter/EqMetadata",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Greeter_Metadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.greeter.v2.services.Greeter/Metadata",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Greeter_Trailer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MetadataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).Trailer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.greeter.v2.services.Greeter/Trailer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Trailer(ctx, req.(*MetadataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Greeter_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.greeter.v2.services.Greeter/Status",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "example.greeter.v2.services.Greeter",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Trailer",
			Handler:    _Greeter_Trailer_Handler,
		},
		{
			MethodName: "Status",
	...
	Metadata: "greeter/v2/services/greeter.proto",
}
