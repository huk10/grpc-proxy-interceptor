...
func (c *greeterClient) Trailer(ctx context.Context, in *MetadataRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/example.greeter.v1.services.Greeter/Trailer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_Trailer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.greeter.v1.services.Greeter/Trailer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "greeter/v1/services/greeter.proto",
}
